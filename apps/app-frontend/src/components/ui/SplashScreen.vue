			...
			<div class="app-logo-wrapper" data-tauri-drag-region>
				<div class="flex flex-col items-center justify-center mb-6">
					<img
						src="/icon.png"
						alt="PawsMC"
						class="w-32 h-32 object-contain drop-shadow-[0_10px_30px_rgba(56,189,248,0.45)] select-none pointer-events-none mb-2"
					/>
					<div class="flex items-baseline font-black tracking-tight text-3xl select-none">
						<span class="text-contrast font-extrabold">Paws</span>
						<span class="text-brand font-black ml-1">MC</span>
					</div>
				</div>
