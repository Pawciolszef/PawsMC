...
const messages = defineMessages({
	...
	signInHeading: {
		...
		defaultMessage: 'Sign in to a PawsMC account',
	},
	description: {
		id: 'modal.modrinth-account-required.description',
		defaultMessage:
			"You'll need to sign into your PawsMC account before you can use this feature.",
	},
	createAccountButton: {
	...
	signInButton: {
		...
		defaultMessage: 'Sign in to PawsMC',
	},
